...
public class DailyRoutineController {
    ...
    public void postDailyRoutine(@RequestBody @Valid final Request request) {
        ...
        dailyRoutineService.postDailyRoutine(routineTimes, request.routineType, request.routineDescription);
    }
